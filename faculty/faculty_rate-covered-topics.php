<?php 
    ...
    $home = "faculty_home_page.php";
    $back = "faculty_home_page.php";
...
<head>
    <title>Student Faculty Interaction | Faculty-Course Handout</title>
    <meta charset="utf-8">
...
<?php include('../header.php'); ?>
                                    ...
                                    <div class="panel-group wrap" id="accordion" role="tablist" aria-multiselectable="true">
                                        ...
                                        <?php 
                                            foreach($courseTopicAndStatus as $row) { 
                                                ...
                                                $topicRating = $faculty_ob->faculty_getTopicRating($courseCode, $session, $row['topic'], $db);
                                        ...
                                        <div class="topic_and_subtopic">
                                            <div class="panel-heading" role="tab">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="panel-title">
                                                        ...
                                                        <?php echo $row['topicStatus']; ?> <?php echo $inputDisable; ?> ></div>
                                                        ...
                                                        <button type="button" name="edit_link">Edit</button>
                                                    </div>
                                                </div>
                                            ...
                                            <?php
                                                ...
                                                $subtopicRating = $faculty_ob->faculty_getSubtopicRating($courseCode, $session, $row['topic'], $subtopics['subtopic'], $db);
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                '<?php echo $courseCode; ?>', this)" <?php echo $subtopics['subtopicStatus']; ?> ></div>
    ...
    <script type="text/javascript" src="../js/faculty_course_handout.js"></script>
